...
public final class ModulePanel extends Container {
    ...
    private static void drawSwitch(final Renderer renderer, final float x, final float y, final boolean checked) {
        ...
        renderer.optimizedFillRoundedRect(x, y, 24, 12, 6, track);
    ...
    private final class TopBar extends Component {
        ...
        public void render(final Renderer renderer, final Rectangle bounds) {
            ...
            drawText(this, renderer, "ANARCHY", TEXT, 14, 23, TextOrigin.Horizontal.LOGICAL_LEFT, TextOrigin.Vertical.BASELINE);
            drawText(this, renderer, "client", ACTIVE, 82, 23, TextOrigin.Horizontal.LOGICAL_LEFT, TextOrigin.Vertical.BASELINE);
            ...
            for (Tab tab : Tab.values()) {
                ...
                drawText(this, renderer, tab.label, color, tabX, 24, TextOrigin.Horizontal.LOGICAL_LEFT, TextOrigin.Vertical.BASELINE);
                if (ModulePanel.this.selectedTab == tab) {
                    renderer.fillRect(tabX, tabY, width - 8F, 2F, ACTIVE);
                }
                tabX += width;
            }
        ...
        protected boolean onComponentMouseDown(final MouseButtonEvent event, final Rectangle bounds) {
            ...
            if (x >= bounds.width() - 34F && x <= bounds.width() - 12F && event.y() >= 6F && event.y() <= 32F) {
                ModulePanel.this.openDrawer(Drawer.ROOT);
                return true;
            }
            if (x >= bounds.width() - 60F && x <= bounds.width() - 38F && event.y() >= 6F && event.y() <= 32F) {
    ...
    private final class CategoryRail extends Component {
        ...
        public void render(final Renderer renderer, final Rectangle bounds) {
            renderer.fillRect(0, 0, bounds.width(), bounds.height(), SHELL);
            drawText(this, renderer, "Modules", TEXT, 22, 32, TextOrigin.Horizontal.LOGICAL_LEFT, TextOrigin.Vertical.BASELINE);
            float y = 56F;
            for (ModuleCategory category : ModuleCategory.values()) {
                ...
                drawIcon(renderer, categoryIcon(category), 17F, y + 10F, selected ? ACTIVE : FAINT);
                drawFittedText(this, renderer, category.displayName(), textColor, 42, y + 21F,
                        Math.max(0F, bounds.width() - 78F), TextOrigin.Horizontal.LOGICAL_LEFT, TextOrigin.Vertical.BASELINE);
                if (enabled > 0) {
                    drawText(this, renderer, String.valueOf(enabled), selected ? ACTIVE : FAINT, bounds.width() - 24F, y + 21F,
    ...
    private final class ModuleRow extends Component {
        ...
        public void render(final Renderer renderer, final Rectangle bounds) {
            ...
            float summaryX = 152F;
            float nameMaxWidth = ModulePanel.this.showSummaries && !ModulePanel.this.compactRows
                    ? summaryX - 28F
                    : controlsX - 28F;
            drawFittedText(this, renderer, this.module.name(), nameColor, 18,
                    bounds.height() / 2F - (ModulePanel.this.showSummaries ? 3F : -4F),
                    Math.max(0F, nameMaxWidth), TextOrigin.Horizontal.LOGICAL_LEFT, TextOrigin.Vertical.BASELINE);
            if (ModulePanel.this.showSummaries && !ModulePanel.this.compactRows) {
                drawFittedText(this, renderer, moduleSummary(this.module), FAINT, summaryX, bounds.height() / 2F + 6F,
                        Math.max(0F, controlsX - summaryX - 16F),
                        TextOrigin.Horizontal.LOGICAL_LEFT, TextOrigin.Vertical.BASELINE);
            }
        ...
        protected boolean onComponentMouseDown(final MouseButtonEvent event, final Rectangle bounds) {
            ...
            float switchX = bounds.width() - 58F;
            if (event.x() >= switchX && event.x() <= switchX + 34F) {
    ...
    private final class InspectorHeader extends Component {
        ...
        public void render(final Renderer renderer, final Rectangle bounds) {
            ...
            if (module == null) {
                drawText(this, renderer, "No module", MUTED, 16, 34, TextOrigin.Horizontal.LOGICAL_LEFT, TextOrigin.Vertical.BASELINE);
                return;
            }
            drawFittedText(this, renderer, module.name(), TEXT, 16, 26,
                    Math.max(0F, bounds.width() - 112F), TextOrigin.Horizontal.LOGICAL_LEFT, TextOrigin.Vertical.BASELINE);
            drawFittedText(this, renderer, module.category().displayName(), FAINT, 16, 50,
                    Math.max(0F, bounds.width() - 82F), TextOrigin.Horizontal.LOGICAL_LEFT, TextOrigin.Vertical.BASELINE);
        ...
        @Override
        protected boolean onComponentMouseDown(final MouseButtonEvent event, final Rectangle bounds) {
            if (event.button() == MouseButton.LEFT && ModulePanel.this.selectedModule != null
                    && event.x() >= bounds.width() - 54F && event.y() >= 34F && event.y() <= 58F) {
    ...
    private static final class GroupHeader extends Component {
        ...
        public void render(final Renderer renderer, final Rectangle bounds) {
            renderer.fillRect(0, 0, bounds.width(), bounds.height(), SHELL);
            drawText(this, renderer, this.name, MUTED, 12, 16, TextOrigin.Horizontal.LOGICAL_LEFT, TextOrigin.Vertical.BASELINE);
        }
    ...
    private abstract static class SettingLine extends Component {
        ...
        public void render(final Renderer renderer, final Rectangle bounds) {
            renderer.fillRect(0, 0, bounds.width(), bounds.height(), SURFACE);
            renderer.line(0, bounds.height() - 1, bounds.width(), bounds.height() - 1, 1, BORDER_SOFT);
            drawFittedText(this, renderer, this.setting.name(), MUTED, 12, bounds.height() / 2F + 5F,
                    Math.max(0F, this.labelMaxWidth(bounds)), TextOrigin.Horizontal.LOGICAL_LEFT, TextOrigin.Vertical.BASELINE);
        }
    ...
    private static final class BooleanSettingRow extends SettingLine {
        ...
        public void render(final Renderer renderer, final Rectangle bounds) {
            super.render(renderer, bounds);
            drawSwitch(renderer, bounds.width() - 38, bounds.height() / 2F - 6F, this.setting.value());
        }
    ...
    private static final class ValueSettingRow extends SettingLine {
        ...
        public void render(final Renderer renderer, final Rectangle bounds) {
            ...
            drawText(this, renderer, value, TEXT, bounds.width() - 12,
                    bounds.height() / 2F + 5F, TextOrigin.Horizontal.VISUAL_RIGHT, TextOrigin.Vertical.BASELINE);
        }
    ...
    private static final class NumberSettingRow extends Container {
        ...
        public void render(final Renderer renderer, final Rectangle bounds) {
            renderer.fillRect(0, 0, bounds.width(), bounds.height(), SURFACE);
            renderer.line(0, bounds.height() - 1, bounds.width(), bounds.height() - 1, 1, BORDER_SOFT);
            drawFittedText(this, renderer, this.setting.name(), MUTED, 12, 18,
                    Math.max(0F, bounds.width() - 74F), TextOrigin.Horizontal.LOGICAL_LEFT, TextOrigin.Vertical.BASELINE);
            drawFittedText(this, renderer, SettingControls.displayValue(this.setting), TEXT, bounds.width() - 12, 18,
    ...
    private static final class TextSettingRow extends Container {
        ...
        public void render(final Renderer renderer, final Rectangle bounds) {
            ...
            drawFittedText(this, renderer, this.setting.name(), MUTED, 12, bounds.height() / 2F + 5F,
                    labelWidth, TextOrigin.Horizontal.LOGICAL_LEFT, TextOrigin.Vertical.BASELINE);
            super.render(renderer, bounds);
        }
    ...
    private final class FriendsPanel extends Container {
        ...
        public void render(final Renderer renderer, final Rectangle bounds) {
            renderer.fillRect(0, 0, bounds.width(), bounds.height(), SURFACE);
            drawText(this, renderer, "Friends", TEXT, 0, 16, TextOrigin.Horizontal.LOGICAL_LEFT, TextOrigin.Vertical.BASELINE);
            super.render(renderer, bounds);
        }
    ...
    private final class FriendRow extends Component {
        ...
        public void render(final Renderer renderer, final Rectangle bounds) {
            ...
            renderer.line(0, bounds.height() - 1, bounds.width(), bounds.height() - 1, 1, BORDER_SOFT);
            drawText(this, renderer, this.friend, TEXT, 12, 21, TextOrigin.Horizontal.LOGICAL_LEFT, TextOrigin.Vertical.BASELINE);
            drawText(this, renderer, "Remove", MUTED, bounds.width() - 12, 21, TextOrigin.Horizontal.VISUAL_RIGHT, TextOrigin.Vertical.BASELINE);
        }
    ...
    private final class ProfilesPanel extends Container {
        ...
        public void render(final Renderer renderer, final Rectangle bounds) {
            renderer.fillRect(0, 0, bounds.width(), bounds.height(), SURFACE);
            drawText(this, renderer, "Profiles", TEXT, 0, 16, TextOrigin.Horizontal.LOGICAL_LEFT, TextOrigin.Vertical.BASELINE);
            super.render(renderer, bounds);
        }
    ...
    private final class ProfileRow extends Component {
        ...
        public void render(final Renderer renderer, final Rectangle bounds) {
            renderer.fillRect(0, 0, bounds.width(), bounds.height(), SURFACE_SOFT);
            renderer.line(0, bounds.height() - 1, bounds.width(), bounds.height() - 1, 1, BORDER_SOFT);
            drawText(this, renderer, this.profile.name(), TEXT, 12, 18, TextOrigin.Horizontal.LOGICAL_LEFT, TextOrigin.Vertical.BASELINE);
            drawText(this, renderer, this.profile.modules() + " modules", FAINT, 12, 36, TextOrigin.Horizontal.LOGICAL_LEFT, TextOrigin.Vertical.BASELINE);
            drawText(this, renderer, "Apply", ACTIVE, bounds.width() - 72, 26, TextOrigin.Horizontal.VISUAL_RIGHT, TextOrigin.Vertical.BASELINE);
            drawText(this, renderer, "Delete", MUTED, bounds.width() - 12, 26, TextOrigin.Horizontal.VISUAL_RIGHT, TextOrigin.Vertical.BASELINE);
        }
    ...
    private final class SettingsDrawer extends Component {
        ...
        private void row(final Renderer renderer, final int index, final String text, final boolean arrow, final boolean toggle, final boolean checked) {
            ...
            drawText(this, renderer, text, toggle || arrow || checked ? TEXT : MUTED, 12, y + 23F,
                    TextOrigin.Horizontal.LOGICAL_LEFT, TextOrigin.Vertical.BASELINE);
            if (toggle) {
    ...
    private static final class EmptyState extends Component {
        ...
        public void render(final Renderer renderer, final Rectangle bounds) {
            renderer.fillRect(0, 0, bounds.width(), bounds.height(), SURFACE);
            renderer.outlineRect(0, 0, bounds.width(), bounds.height(), 1, BORDER_SOFT);
            drawText(this, renderer, this.message, FAINT, 12, 40, TextOrigin.Horizontal.LOGICAL_LEFT, TextOrigin.Vertical.BASELINE);
        }
